...
static CGFloat kDefaultAdditionalOffset = 0.f;
static CGFloat kDefaultSlideAnimationDuration = .5f;

@interface BZRDropDownTableView ()

@property (weak, nonatomic) IBOutlet UITableView *dropDownList;

@property (nonatomic) BZRBaseDropDownDataSource *dropDownDataSource;
...
@implementation BZRDropDownTableView
...
- (void)setAnchorView:(UIView *)anchorView
{
    ...
    if (_anchorView) {
        ...
        savedDropDownTableFrame = CGRectMake(relatedPoint.x, CGRectGetMinY(_anchorView.bounds) + relatedPoint.y, CGRectGetWidth(_anchorView.frame), 0);
